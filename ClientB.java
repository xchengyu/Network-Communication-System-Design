...
public class ClientB {
	public static int udp_port = 32521;
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		File file = new File("D:\\USC\\USC_Textbook\\ee450\\450_project_java_version\\serverB.txt");
		...
		try {
			...
			pw.write("I' m Client B, my local ip is: " + 
...
/*****************************TCP closed**********************************************/
			...
			System.out.println("****Client B UDP socket is listenning·****");
			socket_udp.receive(packet);
			String info=new String(data, 0, packet.getLength());
			System.out.println("Client B has received topology info from Server: "+info
