...
public class ClientD {
	public static int udp_port = 32523;
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		File file = new File("D:\\USC\\USC_Textbook\\ee450\\450_project_java_version\\serverD.txt");
		...
		try {
			...
			pw.write("I' m Client D, my local ip is: " + 
					socket_tcp.getLocalAddress().getHostAddress()
					+ ", my local dynamic TCP port is: " + socket_tcp.getLocalPort()
					+ ", my local static UDP port is: " + udp_port
...
/*****************************TCP closed**********************************************/
			...
			System.out.println("****Client D UDP socket is listenning·****");
			socket_udp.receive(packet);
			String info=new String(data, 0, packet.getLength());
			System.out.println("Client D has received topology info from Server: "+info
